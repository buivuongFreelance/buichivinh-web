...
import { selectArticle } from '../../redux/article';
                ...
                <div className="col-xxl-9 col-xl-8 col-lg-12">
                    <article className="bg-white">
                        <div className="post-img">
                            {article.attributes.mainImage &&
                                <img src={`${ApiManager.adminDomain}${article.attributes.mainImage.data.attributes.url}`} alt="Image"
                                />
                            }
                            <ul className="news-cat list-style">
                                <li><a className="style3">Bài Viết</a></li>
                            </ul>
                        </div>
                        <h2 className="post-title mt-25">{article.attributes.name}</h2>
                        <ul className="news-metainfo list-style mb-20">
                            ...
                            }</a></li>
                            {
                                ...
                                <li><i className="flaticon-user-2"></i>{article.attributes.author.data.attributes.name}</li>
                            }
                    ...
                    <h4 style={{ marginBottom: '20px' }}>Bài viết trên Facebook</h4>
                    <FacebookProvider appId="890921591599086">
                        <EmbeddedPost href={article.attributes.linkFacebook} width="500" />
                    </FacebookProvider>
