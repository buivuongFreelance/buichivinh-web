...
import { selectImportantPoems } from '../../redux/importantPoems';
...
const PoemSection = () => {
    const poems = useSelector(selectImportantPoems);

    if (poems.length === 0) return null;

    return <section className="business-wrap style1 pb-75">
                    ...
                    <div className="row">
                        {
                            poems.map(poem => {
                                ...
                                return <div className="col-lg-4 col-md-4 col-sm-6 col-xs-12" key={poem.id}>
                                    <Link href={`/tho/${poem.id}`}>
